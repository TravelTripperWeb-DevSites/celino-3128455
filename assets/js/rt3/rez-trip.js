(function() {
  angular
    .module('rezTrip', ['angular.filter'], function($interpolateProvider) {
   ...
   .config(function($locationProvider) {
    ...
    .controller('carouselController', ['$scope', function($scope){
      $scope.runHomeRoomsCarousel = runHomeRoomsCarousel;
      $scope.runOtherRoomsCarousel = runOtherRoomsCarousel;
